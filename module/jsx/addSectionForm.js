        ...
        <div key={key} style={{display: 'flex'}}>
          <div style={{flex: '1', display: 'flex', margin: 'auto 20px'}}>
            <div style={{margin: 'auto 20px'}}>
              <TextboxElement
                ...
                required={true}
                errorMessage='Please provide at least one item for this section. You may add more later.'
              />
            </div>
            <div>
              <SelectElement
          ...
          <div style={{marginRight: '-5px'}}>
            <ButtonElement
              ...
              onUserInput={this.props.addSectionContent}
              columnSize=''
              className=''
            />
          </div>
...
AddSectionForm.propTypes = {
  ...
  addSectionContent: PropTypes.func,
};
